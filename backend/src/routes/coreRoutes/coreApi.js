...
const businessInsightsController = require('@/controllers/coreControllers/businessInsightsController');
...
router.route('/admin/read/current').get(catchErrors(adminController.readCurrent));
router.route('/admin/read/:id').get(catchErrors(adminController.read));

router.route('/admin/password-update/:id').patch(catchErrors(adminController.updatePassword));
router.route('/business-insights/chat').post(catchErrors(businessInsightsController.chat));
